...
struct AddressHasher {
	size_t operator()(const Address& address) const {
		...
		return coef * coef * city_hasher(address.city)
			   + coef * city_hasher(address.street)
...
struct PersonHasher {
	size_t operator()(const Person& person) const {
		...
		return coef * coef * coef * name_hasher(person.name)
			   + coef * coef * height_hasher(person.height)
