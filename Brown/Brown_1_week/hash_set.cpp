...
public:
	...
	bool Has(const Type& value) const {
		return !buckets[GetIndex(value)].empty() &&
			   find(buckets[GetIndex(value)].begin(), buckets[GetIndex(value)].end(), value) !=
			   buckets[GetIndex(value)].end();
	}
...
bool CheckWord(const string basicString);
...
int main() {
	...
	auto basicString = q.begin()->first;
	q.erase(basicString);
